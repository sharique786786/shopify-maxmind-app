...
export declare type CreditCardType = 'charge' | 'credit' | 'debit';
...
export declare type DispositionAction = 'accept' | 'reject' | 'manual_review';
export declare type DispositionReason = 'default' | 'custom_rule';
